...
<html lang="en">
  ...
  <body>
    ...
    <script>
      var ttl = <?php echo json_encode($ttl); ?>;
      var bucket_limit = <?php echo json_encode($bucket_limit); ?>;
    </script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@3.5.1/dist/chart.min.js"></script>
    <script type='text/javascript' src='script/ttl-chart.js'> </script>
    <script>
      $(document).ready(function () {
        $("button").click(function () {
          ...
          xmlhttp.open("GET", "includes/httpheaders.inc.php", true);
          xmlhttp.send();
        });
      });
    </script>
